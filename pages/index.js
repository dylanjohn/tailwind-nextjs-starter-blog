...
const currencies = ['CAD', 'USD', 'EUR', 'AFN']
...
export default function Home({ posts }) {
  ...
  return (
    <>
      <ul>
        {currencies.map((currency) => (
          <li key={currency} className="huge">
            <Link href={`/?currencyCode=${currency}`} as={`/currency/${currency}`}>
              <a>{currency}</a>
            </Link>
          </li>
        ))}
      ...
      <div>
        <div className="mb-8 space-y-2 py-6">
        ...
        <div className="divide-y divide-gray-200 dark:divide-gray-700">
          <div className="space-y-2 pt-6 pb-4 md:space-y-4">
            <h2 className="text-2xl font-bold leading-9 tracking-tight text-gray-900 dark:text-gray-100 md:text-3xl">
              Recent projects
            </h2>
          </div>
          <ul>
                    ...
                    <div className="space-y-2 xl:grid xl:grid-cols-3 xl:items-baseline xl:space-y-0">
                      ...
                      <div className="space-y-5 xl:col-span-3">
                        <div className="space-y-6">
                          <div>
                            <h4 className="font-bold leading-8 tracking-tight md:text-xl">
                              <Link
                                href={`/blog/${slug}`}
